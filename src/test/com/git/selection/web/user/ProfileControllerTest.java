...
import static com.git.selection.web.user.ProfileController.REST_URL;
import static com.git.selection.web.user.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
import static com.git.selection.web.user.UserTestData.*;
