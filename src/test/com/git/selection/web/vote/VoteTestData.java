...
import com.git.selection.web.MatcherFactory;

import java.time.LocalDate;
import java.util.List;

import static com.git.selection.web.restaurant.RestaurantTestData.restaurant2;
...
public class VoteTestData {
    ...
    public static final Vote updateVote = new Vote(VOTE_ID + 2, LocalDate.now(), restaurant2);
